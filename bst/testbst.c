...
void testBst() {
    ...
    if (searchResult == NULL)
        ...
        printf("Something is wrong!");
    printf("\n");
    searchResult = searchBST(bst, 9);
    if (searchResult == NULL)
        printf("9 has not been found...");
    else if (searchResult->value ==9)
        printf("9 has been found !");
    else
        printf("Something is wrong!");
    printf("\n");
    ...
    printf("root deleted\n");
    printf("************************\n");
    printf("delete 6  from the tree\n");
// delete a value from the tree
    bst = deleteFromBST(bst, 6);
    prettyPrintBST(bst,4);
    printf("************************\n");
    printf("delete 9  from the tree\n");
    bst = deleteFromBST(bst, 9);
    prettyPrintBST(bst,4);
    printf("************************\n");
    // free the memory of the tree
    freeBST(bst);
  //test the generation of a tree using a permutation
    printf("permutation : {3,2,4,6,9,7,8,0,1,5}\n");
